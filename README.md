...
> **Статус: в разработке.** Готовы этапы 1 и 2 из 5 — окно виджета и буфер обмена. Мониторинг и музыка на подходе, см. [дорожную карту](#дорожная-карта).
...
| 3 | Мониторинг CPU, RAM, температуры | в работе |
