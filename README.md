...
> **Статус: в разработке.** Готовы этапы 1–4 из 5. Остались настройки, автозапуск и полировка — см. [дорожную карту](#дорожная-карта).
...
| 5 | Настройки, автозапуск, локализация, полировка | в работе |
